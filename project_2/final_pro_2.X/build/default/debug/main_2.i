...
# 13 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../std_library.h"
...
# 13 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../std_library.h" 2
...
Timer1_t Timer1={.Timer1_handler=timer1_interrupt,.timer1_mode=0,.timer1_counter_mode=1,
.timer1_osc_cfg=0,.timer1_preload_value=22786,.timer1_prescaler_cfg=3
,.timer1_wr__reg_cfg=1};
...
.i2c_cfg.i2c_SMBus_control=0,.i2c_cfg.i2c_general_call=1,.i2c_cfg.i2c_mode=0
,.i2c_cfg.i2c_mode_cfg=0x06U,.i2c_cfg.i2c_slave_address=0x60,
.i2c_cfg.i2c_slew_rate=1,};

ccp2_t ccp2_={.CCP2_handler = ((void*)0) ,.ccp2_mode=0x0E,.ccp2_pwm_frequence=20000,.pin_config.port=PORTC_INDEX,
.pin_config.pin=pin1,.pin_config.direction=GPIO_OUTPUT,.pin_config.logic=GPIO_LOW,.ccp2_timer2_postscaler_cfg=1,
.ccp2_timer2_prescaler_cfg=1,.ccp2_mode_variant=0x0E};

ADC_conf_t ADC_ = {.ADC_CHANNAL_SELECT=ADC_CHANNEL_AN0,.ADC_interruptHandler=((void*)0),.Acquisition_time=ADC_12_TAD,
