...
# 2 "<built-in>" 2
# 1 "MKAL_layer/CCP1/hal_ccp1.c" 2
...
# 1 "MKAL_layer/CCP1/../mkal_std_types.h" 1
# 11 "MKAL_layer/CCP1/../mkal_std_types.h"
# 1 "MKAL_layer/CCP1/../compiler.h" 1
# 12 "MKAL_layer/CCP1/../compiler.h"
...
# 12 "MKAL_layer/CCP1/../compiler.h" 2
# 11 "MKAL_layer/CCP1/../mkal_std_types.h" 2

# 1 "MKAL_layer/CCP1/../std_library.h" 1
# 13 "MKAL_layer/CCP1/../std_library.h"
...
# 13 "MKAL_layer/CCP1/../std_library.h" 2
...
# 15 "MKAL_layer/CCP1/../std_library.h" 2
# 12 "MKAL_layer/CCP1/../mkal_std_types.h" 2
...
# 13 "MKAL_layer/CCP1/hal_ccp1.h" 2


# 1 "MKAL_layer/CCP1/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MKAL_layer/CCP1/../Interrupt/mcal_internal_interrupt.h"
# 1 "MKAL_layer/CCP1/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MKAL_layer/CCP1/../Interrupt/mcal_interrupt_config.h"
# 1 "MKAL_layer/CCP1/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MKAL_layer/CCP1/../Interrupt/mcal_interrupt_gen_cfg.h"
# 1 "MKAL_layer/CCP1/../Interrupt/../gpio/pro_gpio.h" 1
# 14 "MKAL_layer/CCP1/../Interrupt/../gpio/pro_gpio.h"
# 1 "MKAL_layer/CCP1/../Interrupt/../gpio/../device_config.h" 1
# 14 "MKAL_layer/CCP1/../Interrupt/../gpio/pro_gpio.h" 2
# 36 "MKAL_layer/CCP1/../Interrupt/../gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 12 "MKAL_layer/CCP1/../Interrupt/mcal_interrupt_gen_cfg.h" 2
# 42 "MKAL_layer/CCP1/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "MKAL_layer/CCP1/../Interrupt/mcal_interrupt_config.h" 2
# 12 "MKAL_layer/CCP1/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "MKAL_layer/CCP1/hal_ccp1.h" 2
...
# 8 "MKAL_layer/CCP1/hal_ccp1.c" 2
...
Std_ReturnType ccp1_init (const ccp1_t *ccp1_){
    ...
    else
    {
        ...
        {
# 36 "MKAL_layer/CCP1/hal_ccp1.c"
        }
        else if(ccp1_->ccp1_mode == ccp1_compare_mode_select)
        {
# 55 "MKAL_layer/CCP1/hal_ccp1.c"
        }
        else if(ccp1_->ccp1_mode == 2)
        {
            if(ccp1_->ccp1_mode_variant == 0x0E){
                (CCP1CONbits.CCP1M =0x0E);
            }
            else{ }

                PR2 = (uint8)((8000000UL/(4*ccp1_->timer2_postscaler_cfg *ccp1_->timer2_prescaler_cfg * ccp1_->pwm_frequence))-1);
...
# 218 "MKAL_layer/CCP1/hal_ccp1.c"
void CCP1_ISR (void){
    (PIR1bits.CCP1IF = 0);
