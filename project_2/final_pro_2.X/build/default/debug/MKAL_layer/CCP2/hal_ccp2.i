...
# 2 "<built-in>" 2
# 1 "MKAL_layer/CCP2/hal_ccp2.c" 2
...
# 1 "MKAL_layer/CCP2/../mkal_std_types.h" 1
# 11 "MKAL_layer/CCP2/../mkal_std_types.h"
# 1 "MKAL_layer/CCP2/../compiler.h" 1
# 12 "MKAL_layer/CCP2/../compiler.h"
...
# 12 "MKAL_layer/CCP2/../compiler.h" 2
# 11 "MKAL_layer/CCP2/../mkal_std_types.h" 2

# 1 "MKAL_layer/CCP2/../std_library.h" 1
# 13 "MKAL_layer/CCP2/../std_library.h"
...
# 13 "MKAL_layer/CCP2/../std_library.h" 2
...
# 15 "MKAL_layer/CCP2/../std_library.h" 2
# 12 "MKAL_layer/CCP2/../mkal_std_types.h" 2
...
# 13 "MKAL_layer/CCP2/hal_ccp2.h" 2


# 1 "MKAL_layer/CCP2/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MKAL_layer/CCP2/../Interrupt/mcal_internal_interrupt.h"
# 1 "MKAL_layer/CCP2/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MKAL_layer/CCP2/../Interrupt/mcal_interrupt_config.h"
# 1 "MKAL_layer/CCP2/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MKAL_layer/CCP2/../Interrupt/mcal_interrupt_gen_cfg.h"
# 1 "MKAL_layer/CCP2/../Interrupt/../gpio/pro_gpio.h" 1
# 14 "MKAL_layer/CCP2/../Interrupt/../gpio/pro_gpio.h"
# 1 "MKAL_layer/CCP2/../Interrupt/../gpio/../device_config.h" 1
# 14 "MKAL_layer/CCP2/../Interrupt/../gpio/pro_gpio.h" 2
# 36 "MKAL_layer/CCP2/../Interrupt/../gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 12 "MKAL_layer/CCP2/../Interrupt/mcal_interrupt_gen_cfg.h" 2
# 42 "MKAL_layer/CCP2/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "MKAL_layer/CCP2/../Interrupt/mcal_interrupt_config.h" 2
# 12 "MKAL_layer/CCP2/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "MKAL_layer/CCP2/hal_ccp2.h" 2
...
# 8 "MKAL_layer/CCP2/hal_ccp2.c" 2
...
Std_ReturnType ccp2_init (const ccp2_t *ccp2_){
    ...
    else
    {
        ...
        {
# 36 "MKAL_layer/CCP2/hal_ccp2.c"
        }
        else if(ccp2_->ccp2_mode == ccp2_compare_mode_select)
        {
# 55 "MKAL_layer/CCP2/hal_ccp2.c"
        }
        else if(ccp2_->ccp2_mode == ccp2_pwm_mode_select)
        {
            if(ccp2_->ccp2_mode_variant == 0x0E){
                (CCP2CONbits.CCP2M =0x0E);
            }
            else{ }

                PR2 = (uint8)((8000000UL/(4 *ccp2_->ccp2_timer2_postscaler_cfg *ccp2_->ccp2_timer2_prescaler_cfg * ccp2_->ccp2_pwm_frequence))-1);
...
# 218 "MKAL_layer/CCP2/hal_ccp2.c"
void CCP2_ISR (void){
    (PIR2bits.CCP2IF = 0);
