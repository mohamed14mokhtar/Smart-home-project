# 1 "MKAL_layer/USART/hal_usart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MKAL_layer/USART/hal_usart.c" 2
...
# 1 "MKAL_layer/USART/../mkal_std_types.h" 1
# 11 "MKAL_layer/USART/../mkal_std_types.h"
# 1 "MKAL_layer/USART/../compiler.h" 1
# 12 "MKAL_layer/USART/../compiler.h"
...
# 12 "MKAL_layer/USART/../compiler.h" 2
# 11 "MKAL_layer/USART/../mkal_std_types.h" 2

# 1 "MKAL_layer/USART/../std_library.h" 1
# 13 "MKAL_layer/USART/../std_library.h"
...
# 13 "MKAL_layer/USART/../std_library.h" 2
...
# 15 "MKAL_layer/USART/../std_library.h" 2
# 12 "MKAL_layer/USART/../mkal_std_types.h" 2
...
# 13 "MKAL_layer/USART/hal_usart.h" 2


# 1 "MKAL_layer/USART/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MKAL_layer/USART/../Interrupt/mcal_internal_interrupt.h"
# 1 "MKAL_layer/USART/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MKAL_layer/USART/../Interrupt/mcal_interrupt_config.h"
# 1 "MKAL_layer/USART/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MKAL_layer/USART/../Interrupt/mcal_interrupt_gen_cfg.h"
# 1 "MKAL_layer/USART/../Interrupt/../gpio/pro_gpio.h" 1
# 14 "MKAL_layer/USART/../Interrupt/../gpio/pro_gpio.h"
# 1 "MKAL_layer/USART/../Interrupt/../gpio/../device_config.h" 1
# 14 "MKAL_layer/USART/../Interrupt/../gpio/pro_gpio.h" 2
# 36 "MKAL_layer/USART/../Interrupt/../gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 12 "MKAL_layer/USART/../Interrupt/mcal_interrupt_gen_cfg.h" 2
# 42 "MKAL_layer/USART/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "MKAL_layer/USART/../Interrupt/mcal_interrupt_config.h" 2
# 12 "MKAL_layer/USART/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "MKAL_layer/USART/hal_usart.h" 2
...
# 8 "MKAL_layer/USART/hal_usart.c" 2
...
static void baudrate_calculate(const usart_t *usart){
    ...
    switch (usart->buadrate_gen){
        case BAUDRATE_ASY_8BIT_LOW_SPEED :
            ...
            baud_rate = (((8000000UL/(float)usart->baudrate)/64)-1);
            break;
        case BAUDRATE_ASY_8BIT_HIGH_SPEED :
            ...
            baud_rate = (((8000000UL/(float)usart->baudrate)/16)-1);
            break;
        ...
        case BAUDRATE_ASY_16BIT_HIGH_SPEED :
            ...
            baud_rate = (((8000000UL/(float)usart->baudrate)/4)-1);
            break;
...
static void usart_async_tx_int(const usart_t *usart){
    if(usart->usart_tx.usart_tx_enable == 1){
        TXSTAbits.TXEN =1;
        if(usart->usart_tx.usart_tx_interrupt_enable == 1){
            (PIE1bits.TXIE = 1);
            USART_TX_Interrupthandler = usart->USART_TX_INTERRUPT_HANDLER;

            (PIE1bits.TXIE = 1);
# 188 "MKAL_layer/USART/hal_usart.c"
        (INTCONbits.GIE =1);
        (INTCONbits.PEIE =1);
        ...
        else if(usart->usart_tx.usart_tx_interrupt_enable == 0){
            (PIE1bits.TXIE = 0);
        }
        else{ }
        if(usart->usart_tx.usart_tx_9bits_enable == 1){
            TXSTAbits.TX9 = 1;
        }
        else if(usart->usart_tx.usart_tx_interrupt_enable == 0){
            TXSTAbits.TX9 = 0;
    ...
    else if(usart->usart_tx.usart_tx_enable == 1){
        TXSTAbits.TXEN =1;
    }
    else{ }
}
...
static void usart_async_rx_int(const usart_t *usart){
    if(usart->usart_rx.usart_rx_enable == 1){
        RCSTAbits.CREN =1;
        if(usart->usart_rx.usart_rx_interrupt_enable == 1){
            (PIE1bits.RCIE = 1);
...
# 233 "MKAL_layer/USART/hal_usart.c"
        (INTCONbits.GIE =1);
        (INTCONbits.PEIE =1);
        ...
        else if(usart->usart_rx.usart_rx_interrupt_enable == 0){
            (PIE1bits.RCIE = 0);
        }
        else{ }
        if(usart->usart_rx.usart_rx_9bits_enable == 1){
            RCSTAbits.RX9 = 1;
        }
        else if(usart->usart_rx.usart_rx_interrupt_enable == 0){
            RCSTAbits.RX9 = 0;
    ...
    else if(usart->usart_rx.usart_rx_enable == 1){
        RCSTAbits.CREN =1;
    }
    else{ }
}
